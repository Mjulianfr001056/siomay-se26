...
class ReleaseVersionTests(unittest.TestCase):
    def test_only_newer_numeric_package_versions_are_accepted(self):
        ...
        self.assertFalse(is_newer_package_version("2026.1.0.1"))
        self.assertTrue(is_newer_package_version("2026.1.1.0.4"))
...
class UpdateManifestTests(unittest.TestCase):
    def test_newer_official_release_is_returned(self):
        update = parse_update_manifest({
            "display_version": "v2026.1.1-beta.4",
            "package_version": "2026.1.1.0.4",
            "download_url": (
                "https://github.com/Mjulianfr001056/siomay-se26/releases/"
                "download/v2026.1.1-beta.4/SIOMAY-Setup-2026.1.1.0.4.exe"
            ),
            "release_notes_url": (
        ...
        self.assertEqual(update.package_version, "2026.1.1.0.4")

    def test_current_version_returns_no_update(self):
        update = parse_update_manifest({
            "display_version": "v2026.1.1-beta.3",
            "package_version": "2026.1.1.0.3",
